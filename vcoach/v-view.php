...
if (isset($_SESSION['sports_type']) && $_SESSION['sports_type'] !== 'volleyball') {
...
<head>
    ...
    <title>Asiatech Student Athlete Progress Portal</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar-->
        <?php include('./components/v-sidebar.php'); ?>

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">

            <!-- Header Content -->
            <?php include('./components/v-header.php'); ?>
            ...
            <div id="content">
                 ...
                 <div id="page-content" style="width: 100%;">
                    ...
                    <?php include "pages/list-stud.php"; ?>
                    <?php include "pages/counting-stud.php"; ?>
                    <?php include "pages/v-profile.php"; ?>
                </div>
